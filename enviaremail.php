...
try {
    ...
    //Remetente
    $mail->setFrom('projetolivraria1305@gmail.com', 'Livraria Iserj');
    ...
    //Corpo do Email
    $texto = "Clique <a href='projetobiblioteca1305.000webhostapp.com/projetoatualizado/usuariovalidaremail.php?id=" . $campoemail . "&validador=" . $validador . "'>aqui</a>.";    
    $mail->Body    = $texto;
